...
public class DBConnTest {
    ...
    public static void testConnection() {
        ...
        try {
            ...
            st.executeUpdate(
                "INSERT INTO sample (name, time) VALUES ('test1', 'party like its 1999')");
            st.executeUpdate(
                "INSERT INTO sample (name, time) VALUES ('test2', 'the time, what time is it')");
            st.executeUpdate(
                "INSERT INTO sample (name, time) VALUES ('test3', 'time flies')");
            conn.commit();
